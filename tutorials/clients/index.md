...
IBM&reg; DevOps Services lets you decide how you code.
...
6. Paste the copied Git URL in to the **URI** field. Enter your Jazz ID and IBM ID password in the Authentication section. Click **Next**.
