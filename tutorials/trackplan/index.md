...
5. Use the **Priority** drop-down menu to change the priority to **High**. Now, click **Save** to capture your changes and click **< Back to Backlog** ![< Back to Backlog][14] to return to the backlog.
...
**Note**: If you do not see both the **Open** and **In Progress lanes**, click **Display as Lanes** ![Display as Lanes][20] to switch from the list view.
...
[6]: /tutorials/trackplan/images/gearicon.gif
...
[14]: /tutorials/trackplan/images/backtobacklog.gif
...
[20]: /tutorials/trackplan/images/displaylanes.gif
