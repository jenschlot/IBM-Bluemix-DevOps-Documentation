...
A project owner can do everything that a project admin and member can do and more. Only project owners can do these tasks:
* Rename the project
...
Each project admin can do these tasks:
