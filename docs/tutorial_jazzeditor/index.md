...
>	![Join us in beta](/tutorials/tutorial_jazzeditor/images/bm-join.png)
...
>	![Bluemix dashboard](/tutorials/tutorial_jazzeditor/images/bm-home.png)
...
>	![Bluemix NodeJS app](/tutorials/tutorial_jazzeditor/images/bm-web-starter.png)
...
>	![BlueMix Create App dialog](/tutorials/tutorial_jazzeditor/images/bm-create.png)
...
>	![BlueMix Application tile](/tutorials/tutorial_jazzeditor/images/bm-app-panel.png)

When you click the URL on the tile, it takes you to your already Internet-visible, running application.

 
>	![A running web application](/tutorials/tutorial_jazzeditor/images/bm-example.png)
...
>	![Add Git Integration button](/tutorials/tutorial_jazzeditor/images/bm-add-git-integration.png)
...
>	![DevOps Services sign in page](/tutorials/tutorial_jazzeditor/images/jh-signin.png)
...
>	![Create Git repo dialog](/tutorials/tutorial_jazzeditor/images/bm-create-git-repo.png)

Success! You've created a Git repo, loaded it with the example code, and deployed the app, all in a few clicks.

>	![Git repo success message dialog](/tutorials/tutorial_jazzeditor/images/bm-git-repo-success-msg.png)


Now let's go see the status of the deployed app. Go to the BlueMix Dashboard and click **CODE**.

>	![CODE button](/tutorials/tutorial_jazzeditor/images/bm-code-button.png)
...
>	![Web IDE](/tutorials/tutorial_jazzeditor/images/orion.png)

Clicking that button opens a page that lets you configure and see the status of deployment from this project.

>	![DevOps Services auto deploy page](/tutorials/tutorial_jazzeditor/images/jh-auto-deploy.png)
...
>	![Clone the local repository](/tutorials/tutorial_jazzeditor/images/cli-git-clone.png)
...
>	![Changing the title](/tutorials/tutorial_jazzeditor/images/cli-edit-file.png)

and then do another `git push`, like this image:

>	![Pushing the change](/tutorials/tutorial_jazzeditor/images/cli-edit-push.png)
...
>	![Auto-deploy in action](/tutorials/tutorial_jazzeditor/images/jh-auto-deployed.png)
...
>	![Application page showing new title](/tutorials/tutorial_jazzeditor/images/app-new-title.png)
...
>	![Orion at DevOps Services](/tutorials/tutorial_jazzeditor/images/orion.png)
...
>	![Orion showing express completions](/tutorials/tutorial_jazzeditor/images/completion.png)
...
>	![Orion Git status menu](/tutorials/tutorial_jazzeditor/images/orion-git-status.png)

From the Git Status page, fetch then merge your app title change.

>	![Orion Git merge](/tutorials/tutorial_jazzeditor/images/orion-git-merge.png)
...
>	![Orion editing index](/tutorials/tutorial_jazzeditor/images/orion-really-cool.png)
...
>	![Orion Git staging](/tutorials/tutorial_jazzeditor/images/orion-git-stage.png)

... commit...

>	![Orion Git commit](/tutorials/tutorial_jazzeditor/images/orion-commit.png)

... and push the change...

>	![Orion Git push](/tutorials/tutorial_jazzeditor/images/orion-push.png)
...
>	![Our really cool app](/tutorials/tutorial_jazzeditor/images/really-cool.png)
