...
* [Connect to an existing Git repository](#connect_to_an_existing_git_repository)
...
<a name="connect_to_an_existing_git_repository"></a>
...
2. [Checkout](#start_working_on_a_local_branch) the remote version of the destination branch.
